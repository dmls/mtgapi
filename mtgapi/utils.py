...
def sample_card():
    return {
        {
            "_id" : ObjectId("66357275d94bd3d2eb53caac"),
            ...
            "original_text" : "First strike (This creature deals combat damage before creatures without first strike.)\nWhen Ancestor's Chosen comes into play, you gain 1 life for each card in your graveyard.",
